...
public class main extends javax.swing.JFrame {
  ...
  login lgn = new login();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int d =lgn.login(us, passw);
        
        if(d==1){
            JOptionPane.showMessageDialog(rootPane, "Log in successfully", "MESSAGE", JOptionPane.INFORMATION_MESSAGE);
            user.setText("");pass.setText("");this.setVisible(false);thirdmain mn = new thirdmain(); mn.setLocationRelativeTo(null);mn.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.setVisible(false);signup sn = new signup();sn.setVisible(true);sn.setLocationRelativeTo(null);
